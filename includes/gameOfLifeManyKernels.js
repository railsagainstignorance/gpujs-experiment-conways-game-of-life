const GOLMK = (function(){
  ...
  function create( config ){
    ...
    const loadGridKt = gpu.createKernel(function(a) {
    ...
    const cloneGridKt = gpu.createKernel(function(a) {
        return a[this.thread.x][this.thread.y];
    }, {
      constants: {
        sizeX: config.sizeX,
    ...
    const renderK = gpu.createKernel(function(grid) {
